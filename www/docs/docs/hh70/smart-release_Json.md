...
- `2017 4-21` `jundai.hu` add API GetActivePicopoint,SetActivePicopoint
...
******************************************************************
#### 5.12.8 SetConnectedDeviceRight
